========================================================================
    APLICACIÓN DE CONSOLA: TestSocketClient 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación TestSocketClient.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación TestSocketClient.


TestSocketClient.vcxproj
...
TestSocketClient.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado TestSocketClient.pch y un archivo de tipos 
